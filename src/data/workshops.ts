...
export const workshopEvents: WorkshopEvent[] = [
  { slug: 'soultap-gegen-angst',      title: 'SoulTap gegen deine Angst',  date: '2026-09-14', color: 'gold',      productId: 'b841251e-7e81-40a2-8f96-9524ec9ffcc4', formEmbed: 'CGcMnT548xKfg3bxToApPQ', price: 'CHF 66.–' },
  { slug: 'vagusnerv-ruhe',           title: 'Im Vagusnerv liegt die Ruhe', date: '2026-10-22', color: 'lavender',  productId: 'f46aa359-15ee-4f24-a127-31925311acfb', formEmbed: 'U1jxil-yQVTQha0hRkObHA', price: 'CHF 66.–' },
  { slug: 'cool-down-for-christmas',  title: 'Cool down for Christmas',     date: '2026-11-24', color: 'raspberry', productId: '6c346a3f-c4a2-41e6-9b21-8f5761724dc7', formEmbed: 'pfiDTgsxW6feL04yYDLg3w', price: 'CHF 66.–' },
  { slug: 'adventsgeschichten',       title: 'Advents-Geschichten',         date: '2026-12-01', color: 'fire',      productId: 'bfd1dc0d-a7e1-495c-a165-d4a1c2b545a9', formEmbed: 'URbwPomF2htyOEDv1eYLig', free: true },
];
